// SPDX-License-Identifier: MIT
  ...
  /*
    Website: https://app.TTears.org/
    X/Twitter: https://x.com/Experiments_io
    Telegram: https://t.me/TTears
...
contract TariffTears is ERC20, Ownable {
    ...
    constructor() ERC20("Tariff Tears", "TTEARS") payable {
    ...
    function withdrawStuckETHTTears() external  {
        require(msg.sender == feeRecipientAddress || msg.sender == owner());
