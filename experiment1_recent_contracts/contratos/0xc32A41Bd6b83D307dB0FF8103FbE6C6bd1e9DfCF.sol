...
The Official Ethereum Childrens Book on EIP-7918

https://x.com/AyaMiyagotchi/status/1915988626216755361
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Apples of the Infinite Garden";
    string private constant _symbol = unicode"AOTIG";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot870(address a) public view returns (bool){
      return bots[a];
    }
