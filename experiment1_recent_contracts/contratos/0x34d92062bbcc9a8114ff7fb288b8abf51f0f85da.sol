...
contract Code404 is Context, IERC20, Ownable {
    ...
    uint256 private constant _supplyAmount = 1000000000 * 10 ** _decimals;
    ...
    function setTaxes(uint256 newBuyTax, uint256 newSellTax) external onlyOwner {
        require(newBuyTax <= 20, "Buy tax cannot exceed 20%");
        require(newSellTax <= 25, "Sell tax cannot exceed 25%");
        _buyTax = newBuyTax;
        _sellTax = newSellTax;
