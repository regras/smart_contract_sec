...
/*
Telegram: https://t.me/walkingforever
Website: https://foreverwalking.com
X: https://x.com/Walking_Forever
*/
...
contract WalkingForeverContract is Context, IERC20, Ownable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    address payable private constant _taxWallet = payable(0xc34Da77d1750b25BD3aAcbeF2EB0EA8776DD6737);
    string private constant _name = unicode"Walking together with you forever, Kabosu-chan";
    ...
    uint256 private _avoidTaxesAtCount = 50;
