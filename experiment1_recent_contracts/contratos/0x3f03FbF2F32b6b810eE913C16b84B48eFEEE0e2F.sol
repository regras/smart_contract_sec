...
https://x.com/NBCNews/status/1915775377496002831
*/
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"10,000 Tariff Grandpa";
    string private constant _symbol = unicode"万税爷";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot866(address a) public view returns (bool){
      return bots[a];
    }
