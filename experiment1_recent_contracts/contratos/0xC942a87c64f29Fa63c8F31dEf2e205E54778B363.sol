...
contract Chiku is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Shibu's New Chicken Friend";
    string private constant _symbol = unicode"Chiku";
