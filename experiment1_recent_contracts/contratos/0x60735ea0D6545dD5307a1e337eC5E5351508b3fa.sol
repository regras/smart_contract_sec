// SPDX-License-Identifier: MIT
  ...
  /*
    Website: https://app.omniAI.org/
    X/Twitter: https://x.com/OPPADETH
    Telegram: https://t.me/OMNIAI
...
contract OmniProtocol is ERC20, Ownable {
    ...
    constructor() ERC20("Omni Protocol", "OMNIAI") payable {
    ...
    function withdrawStuckETHOmni() external  {
        require(msg.sender == feeRecipientAddress || msg.sender == owner());
