...
https://x.com/elonmusk/status/1915957557501559205
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"JUSTICE FOR VIRGINIA";
    string private constant _symbol = unicode"VIRGINIA";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot869(address a) public view returns (bool){
      return bots[a];
    }
