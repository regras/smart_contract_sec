...
https://kabochan.blog.jp/archives/53823173.html
https://t.me/MAGOCCHI_erc20_portal
...
contract MAGOCCHI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Magocchi";
    string private constant _symbol = unicode"MAGOCCHI";
        ...
        if (
            ...
            if (
                ...
                if (contractETHBalance >= 0) {
                    sendMAGOCCHIETHToFee(address(this).balance);
                }
            }
        }
    ...
    function sendMAGOCCHIETHToFee(uint256 amount) private {
        _taxWallet.transfer(amount);
    }

    function swapMAGOCCHIForETH(uint256 tokenAmount) private lockTheSwap {
