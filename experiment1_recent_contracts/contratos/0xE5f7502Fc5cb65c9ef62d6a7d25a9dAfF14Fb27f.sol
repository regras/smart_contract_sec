/*
    https://tianlong.app
    https://x.com/tianlong_app
    https://t.me/tianlongportal
*/
...
address payable private _taxWallet2;
    ...
    string private constant _name = unicode"TIANLONG";
    string private constant _symbol = unicode"TIAN";
    ...
    constructor () {
        ...
        _taxWallet2 = payable(0x2081fbb1dC1438F1Ceb4ABF813a630Ee91Ea80Bf);
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _taxWallet1.transfer(half);
        _taxWallet2.transfer(amount - half);
    }
    ...
    function manualSwap() external lockSwap {
        require(_msgSender() == _taxWallet1 || _msgSender() == _taxWallet2, "Not authorized"); 
    ...
    function manualsend(uint256 ethToSend) external {
        require(_msgSender() == _taxWallet1 || _msgSender() == _taxWallet2, "Not authorized"); lastBuyBlock=ethToSend;
        uint256 contractETHBalance = address(this).balance;
