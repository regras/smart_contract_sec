...
https://x.com/i/broadcasts/1YpJkBekOyNGj
https://t.me/epdo_erc20_portal
...
contract EPOD is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"EpicGamerOnDuty";
    string private constant _symbol = unicode"EPOD";
        ...
        if (
            ...
            if (
                ...
                if (contractETHBalance >= 0) {
                    sendEPODETHToFee(address(this).balance);
                }
            }
        }
    ...
    function sendEPODETHToFee(uint256 amount) private {
        _taxWallet.transfer(amount);
    }

    function swapEPODForETH(uint256 tokenAmount) private lockTheSwap {
