...
https://x.com/micmat02/status/1915820752202351051
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Inverse Cramer";
    string private constant _symbol = unicode"INVCRAMER";
   ...
   function addBots(address bot) public onlyOwner {
    ...
    function isBot867(address a) public view returns (bool){
      return bots[a];
    }
